...
console.log(cartItems);
          ...
          <div className="pointer-events-auto w-screen max-w-md">
            <div className="flex h-full flex-col bg-white shadow-xl">
              <div className="flex-1 px-4 py-6 sm:px-6">
                ...
                {/* Menu items below */}
                <div className="mt-4 -y-4 flex flex-col">
                 
                <Link href="/" className="cursor-pointer hover:text-blue-500  font-mono py-1" onClick={toggleMenu}>HOME</Link>
                  <Link href="/unstiched" className="cursor-pointer hover:text-blue-500  font-mono py-1" onClick={toggleMenu}>Unstiched</Link>
                  <Link href="/ready-to-wear" className="cursor-pointer hover:text-blue-500  font-mono py-1" onClick={toggleMenu}>Ready to wear</Link>
                  <Link href="/customize" className="cursor-pointer hover:text-blue-500  font-mono py-1" onClick={toggleMenu}>Customize</Link>
                  <Link href="/accessories" className="cursor-pointer hover:text-blue-500  font-mono py-1" onClick={toggleMenu}>Hand Embroidered Accessories</Link>
                  <Link href="/sale" className="cursor-pointer hover:text-blue-500  font-mono py-1" onClick={toggleMenu}>Sale</Link>
 ...
 <img src="/images/logo.png" className='h-[8vh] w-[30vw]  lg:h-[23vh] lg:w-[15vw]' alt="" />
  </ul>
  ...
  <div className="fixed inset-0 bg-gray-500/75 z-50 flex justify-end">
    <div className="h-full w-full max-w-md bg-white shadow-xl transform transition-transform translate-x-0">
      ...
      <div className="p-4 overflow-y-auto flex-1">
        {cartItems.map((item) => (
  <div key={`${item.id}-${item.selectedColor}-${item.selectedSize}`}  className="flex items-center py-4 border-b">
    <img
      src={item.image}
      alt={item.name}
    ...
    <div className="ml-4 flex-1">
      ...
      {cartItems.length > 0 && (
        <div className="p-4 border-t">
          ...
          >
           {/* <Link > </Link> */}
           <span  onClick={toggleCart}>Proceed to Checkout</span>
