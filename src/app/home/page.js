  ...
  return (
    ...
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <h2 className="text-4xl font-semibold mb-8">SALE</h2>
        <div className="flex flex-wrap -m-4">
          {hoodies.map((hoodie) => (
            <div key={hoodie.id} className="lg:w-1/4 md:w-1/2 p-4 w-full">
              <Link href={`/home/${hoodie.id}`} legacyBehavior>
    ...
    <div>
      <img src="https://lamosaik.com/cdn/shop/articles/Bridal_Maxi_Blog_Banner_fe4c3690-2e4d-409f-848d-6792ca828469_1024x.png?v=1697522488" alt=""  className="w-[100vw] shadow-lg"/>
    </div>
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <h2 className="text-4xl font-semibold mb-8">Unstiched</h2>
        <div className="flex flex-wrap -m-4">
          {hoodies.map((hoodie) => (
            <div key={hoodie.id} className="lg:w-1/4 md:w-1/2 p-4 w-full">
